...
namespace CoreWebAPIJWT.Migrations
{
    ...
    [Migration("20240417090413_VillaNumbertoDB")]
            ...
            modelBuilder.Entity("CoreWebAPIJWT.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2024, 4, 17, 14, 34, 10, 223, DateTimeKind.Local).AddTicks(4525),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2024, 4, 17, 14, 34, 10, 223, DateTimeKind.Local).AddTicks(4528),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2024, 4, 17, 14, 34, 10, 223, DateTimeKind.Local).AddTicks(4530),
                            Details = "Beautiful Desinged Created thats has very Old strcture.",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2024, 4, 17, 14, 34, 10, 223, DateTimeKind.Local).AddTicks(4532),
                            Details = "Beautiful Desinged Created thats has very Old strcture.",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2024, 4, 17, 14, 34, 10, 223, DateTimeKind.Local).AddTicks(4534),
                            Details = "Beautiful Desinged Created thats has very Old strcture.",
                            ImageUrl = "https://unsplash.com/photos/a-laptop-and-a-potted-plant-IqBY9blj8Ks",
